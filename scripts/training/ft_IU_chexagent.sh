...
accelerate launch --num_processes 8 --config_file amlt_configs/accelerate_deepspeed_config.local.yaml \
    -m src.train \
    ...
    model.lm_head_model_name_or_path=StanfordAIMI/CheXagent-8b \
