...
def main():
    ...
    for epoch in range(settings.EPOCH):
        ...
        loss, prompt_loss, non_prompt_loss = function.train_sam(args, net, optimizer1, optimizer2, nice_train_loader, epoch, writer)
        ...
        if epoch % args.val_freq == 0 or epoch == settings.EPOCH-1:
            ...
            writer.add_scalar('Eval_score', tol, epoch)
            writer.add_scalar('Eval_iou', eiou, epoch)
            writer.add_scalar('Eval_dice', edice, epoch)
